...
entity&
component::get_parent_ent( ) const
{
  if ( parent_ent ) {
    return *parent_ent;
  }
...
game&
component::get_parent_game( ) const
{
  return get_parent_ent( ).get_parent_game( );
}

subsystem&
component::get_subsys( ) const
{
  if ( subsys ) {
    return *subsys;
  }
...
entity*
component::try_get_parent_entity( ) const
{
  return parent_ent;
}

game*
component::try_get_parent_game( ) const
{
  return parent_ent ? parent_ent->parent_game : nullptr;
}

subsystem*
component::try_get_subsys( ) const
{
  return subsys;
}
