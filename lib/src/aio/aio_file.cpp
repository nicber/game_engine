...
public:
  file_control_block( int f, file_access ac, file_mode m ) : fd( f ), access( ac ), mode( m )
  {
  }
...
file::file( fcb_shr_ptr fcb_ptr ) : cblock( std::move( fcb_ptr ) )
{
}
...
struct fcb_req_wrapper_storage
{
  ...
  fcb_req_wrapper_storage( T dat ) : data( std::move( dat ) )
  {
  }
};
...
public:
  ...
  static std::shared_ptr< fcb_req_wrapper< T, U > > create_fcb_req_wrapper(
    std::enable_if_t< !std::is_same< V, void >::value, file::fcb_shr_ptr > ptr,
    thr_queue::event::promise< T > prom, V data )
  {
    auto res_ptr = std::make_shared< fcb_req_wrapper< T, U > >(
      priv_struct( ), std::move( ptr ), std::move( prom ), std::move( data ) );
  ...
  {
    auto res_ptr =
      std::make_shared< fcb_req_wrapper< T, U > >( priv_struct( ), std::move( ptr ), std::move( prom ) );
  ...
  template < typename V = U >
  fcb_req_wrapper( priv_struct, std::enable_if_t< std::is_same< V, void >::value, file::fcb_shr_ptr > ptr,
                   thr_queue::event::promise< T > prom )
    : fcb_req_wrapper_storage< U >( ), fcb_ptr( std::move( ptr ) ), init_prom( std::move( prom ) )
  {
  }
  ...
  {
    if ( req.data != nullptr ) {
      LOG( ) << "req.data contains a shared pointer that "
                "creates a reference"
  ...
  return make_aio_operation( [ =, p_str = std::move( p_str ) ]( ) mutable {
    ...
    auto uv_code = [ =, p_str = std::move( p_str ) ]( thr_queue::event::promise< file > prom )
    {
      auto open_cb = []( uv_fs_t* req ) {
        auto fcb_is_ptr = get_fcb_req_wrapper_from_req< fcb_init_struct >( req, true );
        ...
        int fd = req->result;
        if ( fd == -1 ) {
          fcb_is_ptr->init_prom.set_exception( file_open_failure( fd, "uv_fs_open" ) );
        } else {
          auto new_fcb = std::make_shared< file::file_control_block >(
            fd, fcb_is_ptr->data.first, fcb_is_ptr->data.second );
  ...
  return make_aio_operation( [ =, cblock = file.cblock ]( ) mutable {
    ...
    auto uv_code = [ =, cblock = std::move( cblock ) ]( auto prom )
    {
      ...
      auto fcb_read_struct_ptr =
        fcb_read_struct::create_fcb_req_wrapper( std::move( cblock ), std::move( prom ), std::move( rres ) );

      auto read_cb = []( uv_fs_t* req ) {
        auto fcb_read_struct_ptr = get_fcb_req_wrapper_from_req< fcb_read_struct >( req, true );
        ...
        if ( req->result < 0 ) {
          ...
          LOG( ) << ss.str( );
          fcb_read_struct_ptr->init_prom.set_exception( file_read_failure( req->result, "uv_fs_read" ) );
          return;
        } else {
      ...
      uv_fs_read( uv_default_loop( ),
                  &fcb_read_struct_ptr->req,
                  fcb_read_struct_ptr->fcb_ptr->fd,
                  &fcb_read_struct_ptr->data.buf,
                  1,
                  offset,
                  read_cb );
    };
  ...
  return make_aio_operation( [ offset, cblock = file.cblock, buf = std::move( buf ) ]( ) mutable {
    ...
    auto uv_code = [ =, cblock = std::move( cblock ), buf = std::move( buf ) ]( auto prom ) mutable
    {
      ...
      auto fcb_write_struct_ptr =
        fcb_write_struct::create_fcb_req_wrapper( std::move( cblock ), std::move( prom ), std::move( buf ) );

      auto write_cb = []( uv_fs_t* req ) {
        auto fcb_write_struct_ptr = get_fcb_req_wrapper_from_req< fcb_write_struct >( req, true );
        ...
        if ( req->result < 0 ) {
          fcb_write_struct_ptr->init_prom.set_exception( file_write_failure( req->result, "uv_fs_write" ) );
          return;
        } else {
          write_result wres;
      ...
      uv_fs_write( uv_default_loop( ),
                   &fcb_write_struct_ptr->req,
                   fcb_write_struct_ptr->fcb_ptr->fd,
                   &fcb_write_struct_ptr->data,
                   1,
                   offset,
                   write_cb );
    };
  ...
  return make_aio_operation( [ offset, cblock = file.cblock ]( ) mutable {
    ...
    auto uv_code = [ =, cblock = std::move( cblock ) ]( auto prom ) mutable
    {
      ...
      auto fcb_trunc_struct_ptr =
        fcb_trunc_struct::create_fcb_req_wrapper( std::move( cblock ), std::move( prom ) );

      auto truncate_cb = []( uv_fs_t* req ) {
        auto fcb_trunc_struct_ptr = get_fcb_req_wrapper_from_req< fcb_trunc_struct >( req, true );
        ...
        if ( req->result < 0 ) {
          fcb_trunc_struct_ptr->init_prom.set_exception(
            file_truncate_failure( req->result, "uv_fs_truncate" ) );
          return;
        } else {
      ...
      uv_fs_ftruncate( uv_default_loop( ),
                       &fcb_trunc_struct_ptr->req,
                       fcb_trunc_struct_ptr->fcb_ptr->fd,
                       offset,
                       truncate_cb );
    };
  ...
  return make_aio_operation( [cblock = fil.cblock]( perform_helper< void > & ph ) mutable {
    ...
    auto uv_code = [ =, cblock = std::move( cblock ) ]( auto prom ) mutable
    {
      ...
      auto fcb_close_struct_ptr =
        fcb_close_struct::create_fcb_req_wrapper( std::move( cblock ), std::move( prom ) );

      auto close_cb = []( uv_fs_t* req ) {
        auto fcb_close_struct_ptr = get_fcb_req_wrapper_from_req< fcb_close_struct >( req, true );
        ...
        thr_queue::default_par_queue( ).submit_work(
          [ result = req->result, fcb_close_struct_ptr = std::move( fcb_close_struct_ptr ) ] {
            ...
            if ( result < 0 ) {
              fcb_close_struct_ptr->init_prom.set_exception( file_close_failure( result, "uv_fs_close" ) );
              return;
            } else {
      ...
      uv_fs_close(
        uv_default_loop( ), &fcb_close_struct_ptr->req, fcb_close_struct_ptr->fcb_ptr->fd, close_cb );
    };
...
unlink( path& p )
{
  ...
  return make_aio_operation( [p_str = std::move( p_str )]( ) mutable {
    auto uv_code = [p_str = std::move( p_str )]( auto prom ) mutable
    {
      ...
      auto unlink_struct_ptr = unlink_struct::create_fcb_req_wrapper( nullptr, std::move( prom ) );

      auto unlink_cb = []( uv_fs_t* req ) {
        auto req_struct_ptr = get_fcb_req_wrapper_from_req< unlink_struct >( req, true );
        ...
        if ( req->result < 0 ) {
          req_struct_ptr->init_prom.set_exception( file_unlink_failure( req->result, "uv_fs_unlink" ) );
          return;
        } else {
      ...
      uv_fs_unlink( uv_default_loop( ), &unlink_struct_ptr->req, p_str.c_str( ), unlink_cb );
    };
    return thr_queue::event::uv_thr_cor_do< void >( std::move( uv_code ) );
  } );
}
...
#define STAT_COMMON( ptr, OP, ... )                                                                          \
  ...
  auto stat_struct_ptr = stat_struct::create_fcb_req_wrapper( ptr, std::move( prom ) );                      \
                                                                                                             \
  auto stat_cb = []( uv_fs_t* req ) {                                                                        \
    auto stat_struct_ptr = get_fcb_req_wrapper_from_req< stat_struct >( req, true );                         \
                                                                                                             \
      ...
      if ( stat_struct_ptr->fcb_ptr != nullptr ) { /* fstat case */                                          \
        thr_queue::default_par_queue( ).submit_work(                                                         \
          [=] { stat_struct_ptr->fcb_ptr->decrement_counter( ); } );                                         \
                                                                                                             ...
                                                                                                             \
    if ( req->result < 0 ) {                                                                                 \
      stat_struct_ptr->init_prom.set_exception( file_##OP##_failure( req->result, "uv_fs_" #OP ) );          \
      return;                                                                                                \
    } else {                                                                                                 \
      ...
      return;                                                                                                \
                                                                                                             ...
                                                                                                             \
  uv_fs_##OP( uv_default_loop( ), &stat_struct_ptr->req, __VA_ARGS__, stat_cb );                             \
  }                                                                                                          \
  ;                                                                                                          \
...
stat( path& p )
{
  ...
  return make_aio_operation([p_str = std::move(p_str)] () mutable {
    ...
    aio_operation< stat_result > fstat( file & f )
    {
