...
uniform_buffer::uniform_buffer(const program &prog, const std::string &block_name,
                               buf_freq_access freq_acc, buf_kind_access kind_acc):
  buffer_and_data_constructor(prog, block_name),
  buffer<unsigned char>(block_size, freq_acc, kind_acc)
{
