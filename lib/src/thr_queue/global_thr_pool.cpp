...
static void
do_schedule( queue& q, event::condition_variable* cv, event::mutex* mt, size_t min, bool first )
{
...
void
schedule_queue( queue q, event::condition_variable& cv, event::mutex& mt, size_t min )
{
