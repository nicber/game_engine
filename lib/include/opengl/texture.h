...
public:
  ...
  void create_empty( cube_map_side side, GLsizei size, GLuint level, texture_internal_format i_f );

  void create_empty( GLsizei width, GLsizei height, GLuint level, texture_internal_format i_f );

  /** \brief Uploads texture data for a certain side of the cubemap texture.
   * It only works if the texture is a cubemap.
   */
  template < typename It >
  void upload( cube_map_side side, GLsizei size, GLuint level, texture_internal_format i_f,
               texture_format fmt, It begin, It end, data_type d_type = data_type::deduce );

  /** \brief Uploads texture data. */
  template < typename It >
  void upload( GLsizei width, GLsizei height, GLuint level, texture_internal_format i_f, texture_format fmt,
               It begin, It end, data_type d_type = data_type::deduce );
