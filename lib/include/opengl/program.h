...
{
public:
  program_construction_error( std::string error, const shader& s1, const shader& s2,
...
public:
  using uniform_cont = boost::multi_index_container<
    uniform_setter, boost::multi_index::indexed_by<
  ...
  program( const shader& s1, const shader& s2, std::initializer_list< shader > shaders,
           std::initializer_list< attrib_pair > attribs, std::initializer_list< frag_data_loc > frag_data );
