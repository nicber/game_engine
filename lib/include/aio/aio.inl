...
protected:
	aiorf
	do_perform_nonblock() final override
	{
		return function();
	}

	void
	do_perform_may_block( perform_helper<result_type> & ) final override
	{
		abort();
	}

	bool
	may_block() final override
	{
		return false;
	}
...
protected:
	...
	void
	do_perform_may_block( perform_helper<result_type> &helper ) final override
	{
		function( helper );
	}
